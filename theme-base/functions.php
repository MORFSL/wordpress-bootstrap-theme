...
define('THEME_FUNCTIONS_PATH', get_stylesheet_directory() . '/includes/theme-functions/');
define('CUSTOM_POST_TYPES', get_stylesheet_directory() . 'includes/admin/post-types');
define('CUSTOM_TAXONOMIES', get_stylesheet_directory() . 'includes/admin/post-taxonomies');
define('THEME_PLUGIN_ACTIVATION_PLUGINS', get_stylesheet_directory() . '/includes/plugin-activation/plugins/');
